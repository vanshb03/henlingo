    ...
    <>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="grid gap-1.5">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Learn American Sign Language (ASL) with ease
                </p>
              </div>
            </div>
      ...
      <section className="grid items-center w-full py-12 gap-4 text-center lg:py-24">
        <div className="container space-y-4">
          ...
          <p className="max-w-3xl mx-auto text-gray-500 md:text-xl/relaxed dark:text-gray-400">
            Dive into engaging lessons that make learning ASL enjoyable. Our
            interactive approach lets you practice signs and sentences while
            having fun.
          </p>
        </div>
        <div className="mx-auto grid max-w-5xl gap-4 px-4 items-start sm:grid-cols-2 md:gap-8 lg:max-w-5xl lg:grid-cols-2">
          <div className="flex flex-col gap-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Learn how to greet others using ASL. Master common phrases and
                gestures.
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Explore signs related to family members. Practice vocabulary and
                expressions.
              </p>
            </div>
          </div>
        ...
        <div className="container space-y-12 px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Access your ASL lessons on the go. Our platform is designed to
                work on all your devices, allowing you to practice signing
                anywhere, anytime.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl gap-8 items-start sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-2">
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Dive into engaging lessons that make learning ASL enjoyable.
                Practice signs and sentences while having fun.
              </p>
            </div>
            <div className="grid gap-1">
              <h3 className="text-lg font-bold">Progress Tracking</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Our platform lets you track your progress as you learn ASL. See
            ...
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Connect with other learners and native signers in our community.
                Get tips, feedback, and support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-4xl gap-12 lg:grid-cols-3">
          <div className="flex flex-col gap-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                "Learning ASL with the ASL Academy has been an amazing
                experience. The lessons are engaging and the platform is easy to
                use. I feel more confident in my signing skills thanks to this
                platform."
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                "The ASL Academy makes learning sign language fun and
                interactive. I love the video lessons and the ability to
                practice my signing with the quizzes. It feels like I have a
                personal tutor guiding me through the lessons."
              </p>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                "I have been using the ASL Academy to learn sign language and I
                am impressed by the quality of the lessons. The platform is
                user-friendly and the instructors are excellent. I highly
                recommend this platform to anyone who wants to learn ASL."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="grid items-center w-full py-12 gap-4 text-center lg:py-24">
        <div className="container space-y-4">
          ...
          <p className="max-w-3xl mx-auto text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            Access all the features of the ASL Academy with a subscription. Pick
