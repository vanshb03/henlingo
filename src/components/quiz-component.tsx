    ...
    <div className="bg-white min-h-screen flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl p-4">
        <div className="flex justify-between items-center">
          ...
          <div className="ml-4" />
          <Progress className="w-full h-2 bg-gray-200 rounded-full overflow-hidden" value={50}>
            <div
        ...
        <div className="mt-12 text-center text-2xl font-semibold">Write this in English</div>
        ...
        <div className="mt-8">
          <Input className="w-full p-4 border-b-2 border-gray-200 text-lg" placeholder="Type in English" />
        </div>
