    ...
    <>
      ...
      <header className="grid items-center w-full py-12 gap-4 text-center lg:py-24">
        ...
        <div className="space-y-4">
          ...
          <Link
            className="mx-auto max-w-[300px] inline-block w-full rounded-md border border-gray-200 border-gray-200 bg-white px-8 py-3 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 sm:max-w-[200px] dark:border-gray-800 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50"
            href="#"
          >
            Tour the Platform
          </Link>
